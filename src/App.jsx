  ...
  useEffect(() => {
    ...
    function tick(ts) {
      ...
      if (isPaused) {
        ...
        ctx.textAlign = "right"; ctx.fillText("— PAUSED —", CW - 8, CH - 8); ctx.restore();
      }
      ctx.save();
      ctx.font = `9px ${T.mono}`; ctx.fillStyle = "rgba(0,200,170,0.26)";
      ctx.textAlign = "center"; ctx.fillText("↑ transcendence", CW / 2, 13);
      ctx.fillText("↓ matter", CW / 2, CH - 6);
      ctx.textAlign = "left";  ctx.fillText("← origin", 5, CH / 2 + 4);
      ctx.textAlign = "right"; ctx.fillText("other →", CW - 5, CH / 2 + 4);
      ctx.restore();
  ...
  return (
    <div style={{ background: T.bg, padding: "1.2rem", display: "flex", flexDirection: "column", gap: 12 }}>
        ...
        <div style={{ flex: "1 1 185px", minWidth: 185, maxWidth: 245, display: "flex", flexDirection: "column", gap: 8 }}>
          ...
          <Panel title="EXISTENTIAL POTENTIAL FIELD">
            ...
            <p style={{ fontFamily: T.mono, fontSize: 9, letterSpacing: "0.05em", color: T.textDim, margin: "4px 0 0", lineHeight: 1.6 }}>
              the field evolves independently of the agents inhabiting it
            </p>
          </Panel>
          ...
          <Panel title="UNCONSCIOUS VECTORS">
            ...
            <div style={{ marginTop: 8, paddingTop: 6, borderTop: `0.5px solid ${T.borderDim}`, display: "flex", alignItems: "center", gap: 8 }}>
              ...
              <span style={{ fontFamily: T.mono, fontSize: 10, letterSpacing: "0.08em", color: T.textSec, flex: 1 }}>RESULTANT</span>
              <div style={{ flex: "0 0 40px", height: 2, background: "rgba(0,200,175,0.10)", borderRadius: 1, overflow: "hidden" }}>
      ...
      <p style={{ fontFamily: T.mono, fontSize: 9, letterSpacing: "0.06em", color: T.textDim, lineHeight: 1.7, margin: 0 }}>
        colored vectors = unconscious impulses · cyan = resultant · drag the node to change the field zone · the field evolves slowly
      </p>
